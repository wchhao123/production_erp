...
CREATE TABLE `c_order`  (
  ...
  `custom_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  INDEX `FK_Reference_28`(`product_id`) USING BTREE,
  INDEX `FK_Reference_5`(`custom_id`) USING BTREE,
...
CREATE TABLE `custom`  (
  `custom_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `custom_name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `owner_tel` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `status` int(11) NULL DEFAULT NULL,
...
CREATE TABLE `department`  (
  `department_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `device`  (
  ...
  `device_type_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `device_status_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `device_status` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `device_purchase_date` datetime(0) NULL DEFAULT NULL,
  `device_purchase_price` decimal(10, 2) NULL DEFAULT NULL,
  `device_manufacture_date` datetime(0) NULL DEFAULT NULL,
  `device_service_life` datetime(0) NULL DEFAULT NULL,
  `device_keeper_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `note` varchar(5000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`device_id`) USING BTREE,
  INDEX `FK_Reference_18`(`device_type_id`) USING BTREE,
...
CREATE TABLE `device_check`  (
  `device_check_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `device_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `device_check_emp_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `device_check_date` datetime(0) NULL DEFAULT NULL,
  `device_check_result` varchar(5000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `device_check_fault_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`device_check_id`) USING BTREE,
  INDEX `FK_Reference_20`(`device_id`) USING BTREE,
...
CREATE TABLE `device_fault`  (
  `device_fault_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `device_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `device_fault_cause` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `device_fault_detail` varchar(5000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `device_fault_date` datetime(0) NULL DEFAULT NULL,
  `device_fault_maintenance` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`device_fault_id`) USING BTREE,
  INDEX `FK_Reference_21`(`device_id`) USING BTREE,
...
CREATE TABLE `device_maintain`  (
  `device_maintain_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `device_fault_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `device_maintain_emp_id` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `device_maintain_date` datetime(0) NULL DEFAULT NULL,
  `device_maintain_result` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `device_maintain_cost` decimal(10, 2) NULL DEFAULT NULL,
  `note` varchar(5000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`device_maintain_id`) USING BTREE,
  INDEX `FK_Reference_22`(`device_fault_id`) USING BTREE,
...
CREATE TABLE `device_type`  (
  `device_type_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `device_type_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `device_type_model` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `device_type_spec` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `device_type_supplier` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `device_type_producer` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `device_type_quantity` int(11) NULL DEFAULT NULL,
  `device_type_warranty` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `employee`  (
  `emp_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `emp_name` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `sex` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `id_code` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `major` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `graduate_school` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `education_form` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `department_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`emp_id`) USING BTREE,
  INDEX `FK_Reference_30`(`department_id`) USING BTREE,
...
CREATE TABLE `final_count_check`  (
  `f_count_check_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `order_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `check_item` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `sample` int(11) NULL DEFAULT NULL,
  `check_number` int(11) NULL DEFAULT NULL,
  `unqualify` int(11) NULL DEFAULT NULL,
  `qualify` decimal(3, 2) NULL DEFAULT NULL,
  `cdate` datetime(0) NULL DEFAULT NULL,
  `measure_data` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `note` varchar(5000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`f_count_check_id`) USING BTREE,
  INDEX `FK_Reference_25`(`order_id`) USING BTREE,
...
CREATE TABLE `final_measuret_check`  (
  `f_measure_check_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `order_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `check_item` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `cdate` datetime(0) NULL DEFAULT NULL,
  `measure_data` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `result` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `note` varchar(5000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`f_measure_check_id`) USING BTREE,
  INDEX `FK_Reference_27`(`order_id`) USING BTREE,
...
CREATE TABLE `manufacture`  (
  `manufacture_sn` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `order_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `technology_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `launch_quantity` int(11) NULL DEFAULT NULL,
  `begin_date` datetime(0) NULL DEFAULT NULL,
  `end_date` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`manufacture_sn`) USING BTREE,
  INDEX `FK_Reference_26`(`order_id`) USING BTREE,
  INDEX `FK_Reference_9`(`technology_id`) USING BTREE,
...
CREATE TABLE `material`  (
  ...
  `material_type` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `material_consume`  (
  `consume_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `work_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `material_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `consume_amount` int(11) NULL DEFAULT NULL,
  `consume_date` datetime(0) NULL DEFAULT NULL,
  `sender` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `receiver` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `note` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`consume_id`) USING BTREE,
  INDEX `FK_Reference_16`(`material_id`) USING BTREE,
  INDEX `FK_Reference_33`(`work_id`) USING BTREE,
...
CREATE TABLE `material_receive`  (
  `receive_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `material_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  INDEX `FK_Reference_15`(`material_id`) USING BTREE,
...
CREATE TABLE `process`  (
  ...
  `technology_plan_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `sequence` int(11) NULL DEFAULT NULL,
  `quota` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`process_id`) USING BTREE,
  INDEX `FK_Reference_32`(`technology_plan_id`) USING BTREE,
...
CREATE TABLE `process_count_check`  (
  `p_count_check_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `process_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `check_item` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `sample` int(11) NULL DEFAULT NULL,
  `check_number` int(11) NULL DEFAULT NULL,
  `unqualify` int(11) NULL DEFAULT NULL,
  ...
  `result` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `note` varchar(5000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`p_count_check_id`) USING BTREE,
  INDEX `FK_Reference_24`(`process_id`) USING BTREE,
...
CREATE TABLE `process_measure_check`  (
  `p_measure_check_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `process_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `check_item` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `cdate` datetime(0) NULL DEFAULT NULL,
  `measure_data` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `result` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `note` varchar(5000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`p_measure_check_id`) USING BTREE,
  INDEX `FK_Reference_23`(`process_id`) USING BTREE,
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('001', 'admin', 'admin', '9');
INSERT INTO `sys_user` VALUES ('002', 'wyl', 'wyl', '1');
INSERT INTO `sys_user` VALUES ('003', 'dyc', 'dyc', '2');
INSERT INTO `sys_user` VALUES ('004', 'zlq', 'zlq', '3');
INSERT INTO `sys_user` VALUES ('005', 'zrq', 'zrq', '4');
INSERT INTO `sys_user` VALUES ('006', 'wjl', 'wjl', '5');
...
CREATE TABLE `task`  (
  ...
  `manufacture_sn` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `work_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `task_quantity` int(11) NULL DEFAULT NULL,
  `working_hours` decimal(10, 0) NULL DEFAULT NULL,
  PRIMARY KEY (`task_id`) USING BTREE,
  INDEX `FK_Reference_34`(`manufacture_sn`) USING BTREE,
  INDEX `FK_Reference_6`(`work_id`) USING BTREE,
...
CREATE TABLE `technology`  (
  ...
  `technology_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `price` decimal(10, 2) NULL DEFAULT NULL,
  `vital_process_period` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `standard_capacity` int(11) NULL DEFAULT NULL,
  `overtime_standard_capacity` int(11) NULL DEFAULT NULL,
  `overtime_overfulfil_capacity` int(11) NULL DEFAULT NULL,
  `double_capacity` int(11) NULL DEFAULT NULL,
  `overfulfil_capacity` int(11) NULL DEFAULT NULL,
...
CREATE TABLE `technology_plan`  (
  `technology_plan_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `technology_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `batch_amount` int(11) NULL DEFAULT NULL,
  `start_plan` datetime(0) NULL DEFAULT NULL,
  `end_plan` datetime(0) NULL DEFAULT NULL,
  `commit_plan` datetime(0) NULL DEFAULT NULL,
  `technology_plan_start` datetime(0) NULL DEFAULT NULL,
  `technology_plan_end` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`technology_plan_id`) USING BTREE,
  INDEX `FK_Reference_31`(`technology_id`) USING BTREE,
...
CREATE TABLE `technology_requirement`  (
  `technology_requirement_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `technology_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `requirement` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `add_time` datetime(0) NULL DEFAULT NULL,
  `revise_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`technology_requirement_id`) USING BTREE,
  INDEX `FK_Reference_10`(`technology_id`) USING BTREE,
...
CREATE TABLE `unqualify_apply`  (
  `unqualify_apply_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `product_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `unqualify_item` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `unqualify_count` int(11) NULL DEFAULT NULL,
  `assembly_date` datetime(0) NULL DEFAULT NULL,
  `emp_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `apply_date` datetime(0) NULL DEFAULT NULL,
  `note` varchar(5000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`unqualify_apply_id`) USING BTREE,
  INDEX `FK_Reference_29`(`product_id`) USING BTREE,
...
CREATE TABLE `work`  (
  `work_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `process_number` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `product_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `process_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `device_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `rating` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`work_id`) USING BTREE,
  INDEX `FK_Reference_12`(`process_id`) USING BTREE,
  INDEX `FK_Reference_17`(`device_id`) USING BTREE,
  INDEX `FK_Reference_7`(`product_id`) USING BTREE,
